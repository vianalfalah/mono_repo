        ...
        setGrid(prevGrid => {
            ...
            if (direction === 'left') {
                ...
                for (let c = 0; c < GRID_SIZE; c++) {
                    ...
                    if (originalCol.join(',') !== resultArr.join(','))
                        moved = true;
                    for (let r = 0; r < GRID_SIZE; r++) {
            ...
            if (moved) {
                ...
                if (!hasEmptyCells) {
                    for (let r = 0; r < GRID_SIZE; r++) {
                        for (let c = 0; c < GRID_SIZE; c++) {
                            if ((r < GRID_SIZE - 1 && gridWithRandom[r][c] === gridWithRandom[r + 1][c]) ||
